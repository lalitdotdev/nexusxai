...
export const EditorCard = ({
    ...
    return (
        <div className="bg-[#0d0d17] border-2 border-slate-700 rounded-lg overflow-hidden shadow-lg flex flex-col ">
            <div className="relative">
                <CloundinaryImage publicId={editor.imagePublicId} className='object-cover h-48 w-full' />
            </div>
            <div className="p-4 flex-grow flex flex-col">
                <div className="flex justify-between items-center mb-2">
                    <Title2 className="text-lg font-semibold text-white truncate">
                        {editor.name}
                    </Title2>
                    {isOwner ? (
