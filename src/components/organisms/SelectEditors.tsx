...
export const SelectEditors = ({ className }: BaseComponent) => {
    const { data: myEditors, isFetching: isFetchingMyEditors } = trpcClient.editors.myEditors.useQuery()
    const { data: favoriteEditors, isFetching: isFetchingFavoriteEditors } = trpcClient.editors.favoriteEditors.useQuery()
...
export const SelectEditorsSkeleton = () => {
    return (
        <div className="fixed bottom-0 left-0 right-0 md:relative md:h-screen md:flex md:flex-col md:justify-center ">
            <div className="flex flex-row md:flex-col items-center gap-2 p-2 md:py-16 bg-white md:bg-transparent border-l border-gray-200 rounded-l-lg">
