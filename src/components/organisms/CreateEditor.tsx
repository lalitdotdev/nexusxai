...
export const CreateEditor = () => {
    ...
    return (
        <form
            ...
            className="bg-gray-900 text-white p-6 rounded-lg shadow-lg max-w-4xl mx-auto"
        >
            ...
            <Button type="submit" className="mt-6 w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                Create
            </Button>
        </form>
    )
